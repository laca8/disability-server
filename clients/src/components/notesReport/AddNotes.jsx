...
const dispatch = useDispatch()
   ...
   dispatch(addNote({note:text,reportId:id}))
      ...
      setNotify(toast.error('الرجاء ادخال متابعة'))
  ...
  return (
    <div>
         <div className='flex flex-col p-3 text-right '>
         {
            ...
            <textarea id="message" rows="4" className="bg-gray-800  rounded-sm w-full border-2 border-gray-400"  value={text} onChange={(e)=>setText(e.target.value)}></textarea>
          </div>
