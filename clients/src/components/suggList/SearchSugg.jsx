  ...
  return (
    ...
    <div className='border-2 border-gray-400'> 
     ...
     <div className='flex flex-col w-auto p-1'>
        ...
        <input value={connName} onChange={(e)=>setConnName(e.target.value)} className='bg-gray-800 p-1 w-full rounded-sm border-2 border-gray-400' type='text' placeholder='ادخل اسم المتصل' />
      </div>
      <div className='flex flex-col  w-auto p-1'>
        <label>رقم التليفون </label>
        <input value={phone} onChange={(e)=>setPhone(e.target.value)} className='bg-gray-800 p-1 rounded-sm border-2 border-gray-400' type='number' placeholder='ادخل رقم التليفون' />
      </div>
      <div className='flex flex-col  w-auto p-1'>
  
          <label>رقم الاستعلام</label>
        <input value={numSugg} onChange={(e)=>setNumSugg(e.target.value)} className='bg-gray-800 p-1 rounded-sm border-2 border-gray-400' type='number' placeholder='ادخل رقم الاستعلام' />
