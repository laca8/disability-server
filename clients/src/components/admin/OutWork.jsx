...
const OutWork = () => {
    ...
    const [data,setData] = useState([])
        const API_URL = 'https://disability-server.vercel.app/api/outWork' 
  ...
  return (
    ...
    <h1 className='p-2 bg-gray-950 rounded-sm text-white font-bold mb-2 mt-32 w-1/2'>خارج قوة العمل</h1>
    ...
    {
      data ?  data?.map((x,i)=>(
            <div key={i} className='p-1 flex flex-row justify-between w-full bg-gray-950 text-white mt-2'>
                <span>{x.title}</span>
