...
//navigator('/')
  ...
  return (
    <nav className='relative w-full h-full bg-gray-900 shadow-sm shadow-black' >
    ...
    <div className={`container  flex flex-row justify-between   `}>
        <div className=' flex flex-row gap-8'>
            ...
            <ul className='flex flex-row  items-center gap-5 cursor-pointer '>
                ...
                <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" onClick={()=>{handleChange()}} className="w-28" type="button">إدارة  الخدمات  {' '}<i className="fa fa-caret-down"></i></button>
...
<div  className={`z-10 absolute bg-white divide-y divide-gray-100 rounded-lg shadow w-44  ${selectedValue ? 'visible' : 'invisible'} `}>
    <ul className="p-1 text-sm text-gray-900 " aria-labelledby="dropdownDefaultButton">
      ...
      <li onClick={()=>{handleChange()}}>
        <a href="/suggDis" className="block p-1 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">تسجيل إستفسارات</a>
      </li>
    </ul>
</div>
                </li>
    ...
    <div className='mt-1 ml-3 text-white'>
      {
                ...
                :  
      <button className='bg-cyan-700 p-2 text-white rounded-sm hover:scale-95' ><a href='/login'>تسجيل الدخول</a></button>
